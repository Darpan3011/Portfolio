  ...
  return (
    <motion.section id="about" className="bg-gray-950"
      ...
      <div className="mx-auto bg-gray-800 px-8 py-14 rounded-lg shadow-lg flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left w-full md:w-1/3 p-4 rounded-lg bg-gray-800 shadow-md space-y-3">
          ...
          <p className="text-gray-300 text-sm leading-tight">
            <span className="font-semibold">Experience:</span> 1.5+ years
          </p>
          <p className="text-gray-400 text-sm font-medium border-b border-gray-700 pb-2">
            Junior Software Engineer
            <span className="text-white font-semibold"> @Dash Technologies</span>
          </p>
          <p className="text-gray-300 text-sm leading-tight">
