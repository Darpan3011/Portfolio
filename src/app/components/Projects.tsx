...
const Projects = () => {
  ...
  return (
    <>
     <motion.section id="projects" className="bg-gray-950"
        ...
        <div className="mx-auto space-y-12">
          {projects.map((project, index) => (
            <motion.div key={index} className="bg-gray-800 p-8 rounded-lg shadow-lg hover:scale-105 transition transform duration-300">
              ...
              <div className="mt-4">
                <Link href={project.link} className="inline-block bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-400 transition-all">
                  View Project
                </Link>
              </div>
            </motion.div>
